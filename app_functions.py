...
def print_question(die_1_value, die_2_value, question_type):
    """
    Prints out a math question that asks the user to calculate either the sum or 
    difference of the two numbers rolled on virtual dice.
    ...
    :param question_type: A string - either "sum" or "difference" - 
    indicating whether the user should calculate the sum or difference of the two integers.
    :returns: None
    """
    # complete this function below here
...
def input_answer():
    ...
    - If the user enters a response that is not valid, including empty responses 
    or responses including non-integer characters, return -1.

    :returns: The user's answer, as an int, if valid; or -1 if the user's response was not valid.
    """
    # complete this function below here
    answer = input ("Answer:")
    answer_format= answer.strip()
    if answer_format.isdigit():
        return int(answer_format)
    else:
        return -1
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    user was asked to add or subtract the two integers.
...
def print_congratulations(question_type):
    ...
    :param question_type: A string - either "sum" or "difference" - indicating
    whether the user was asked to add or subtract the two integers.
    """
    # complete this function below here
    if question_type == "sum":
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    :param die_2_value: The second integer.
    :param question_type: A string - either "sum" or "difference" 
    - indicating whether the user was asked to add or subtract the two integers.
    """
    # complete this function below here
    if question_type == "sum":
